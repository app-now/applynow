if (! function(t, e, i) {
        ...
        function o() {
            ...
            for (var l in b)
                if (b.hasOwnProperty(l)) {
                    ...
                    for (o = n(e.fn, "function") ? e.fn() : e.fn, r = 0; r < t.length; r++) s = t[r], a = s.split("."), 1 === a.length ? C[a[0]] = o : (!C[a[0]] || C[a[0]] instanceof Boolean || (C[a[0]] = new Boolean(C[a[0]])), C[a[0]][a[1]] = o), y.push((o ? "" : "no-") + a.join("-"))
                }
        }
        ...
        function r(t) {
            ...
            C._config.enableClasses && (e += " " + i + t.join(" " + i), T ? _.className.baseVal = e : _.className = e)
        }
        ...
        function c(t, i, n, o) {
            var r, a, c, d, u = "modernizr",
                p = s("div"),
                h = l();
            if (parseInt(n, 10))
                for (; n--;) c = s("div"), c.id = o ? o[n] : u + (n + 1), p.appendChild(c);
            return r = s("style"), r.type = "text/css", r.id = "s" + u, (h.fake ? h : p).appendChild(r), h.appendChild(p), r.styleSheet ? r.styleSheet.cssText = t : r.appendChild(e.createTextNode(t)), p.id = u, h.fake && (h.style.background = "", h.style.overflow = "hidden", d = _.style.overflow, _.style.overflow = "hidden", _.appendChild(h)), a = i(p, t), h.fake ? (h.parentNode.removeChild(h), _.style.overflow = d, _.offsetHeight) : p.parentNode.removeChild(p), !!a
        }
        ...
        function f(e, n) {
            ...
            if ("CSS" in t && "supports" in t.CSS) {
                for (; o--;)
                    if (t.CSS.supports(h(e[o]), n)) return !0;
                return !1
            }
        ...
        function m(t, e, o, r) {
            ...
            for (var u, p, h, m, v, g = ["modernizr", "tspan", "samp"]; !$.style && g.length;) u = !0, $.modElem = s(g.shift()), $.style = $.modElem.style;
            for (h = t.length, p = 0; h > p; p++)
                if (m = t[p], v = $.style[m], d(m, "-") && (m = a(m)), $.style[m] !== i) {
                    if (r || n(o, "undefined")) return l(), "pfx" != e || m;
                    try {
                        $.style[m] = o
                    } catch (y) {}
                    if ($.style[m] != v) return l(), "pfx" != e || m
                } return l(), !1
        }
        ...
        function v(t, e, i, o, r) {
            ...
            return n(e, "string") || n(e, "undefined") ? m(a, e, o, r) : (a = (t + " " + O.join(s + " ") + s).split(" "), p(a, e, i))
        }
        ...
        var _ = e.documentElement,
            ...
            I = w._config.usePrefixes ? " -webkit- -moz- -o- -ms- ".split(" ") : ["", ""];
        w._prefixes = I, C.addTest("video", function() {
            var t = s("video"),
                e = !1;
            try {
        ...
        C.addTest("touchevents", function() {
            ...
            if ("ontouchstart" in t || t.DocumentTouch && e instanceof DocumentTouch) i = !0;
                ...
                var n = ["@media (", I.join("touch-enabled),("), "heartz", ")", "{#modernizr{top:9px;position:absolute}}"].join("");
                x(n, function(t) {
                    i = 9 === t.offsetTop
                })
            }
        ...
        var E = "Moz O ms Webkit",
            k = w._config.usePrefixes ? E.split(" ") : [];
        w._cssomPrefixes = k;
        var S = function(e) {
            var n, o = I.length,
                r = t.CSSRule;
        ...
        w.atRule = S;
        var O = w._config.usePrefixes ? E.toLowerCase().split(" ") : [];
        w._domPrefixes = O;
        var P = {
            elem: s("modernizr")
        };
        ...
        C._q.unshift(function() {
            delete $.style
        }), w.testAllProps = v, w.testAllProps = g, C.addTest("flexbox", g("flexBasis", "1px", !0));
        var M = w.prefixed = function(t, e, i) {
            return 0 === t.indexOf("@") ? S(t) : (-1 != t.indexOf("-") && (t = a(t)), e ? v(t, e, i) : v(t, "pfx"))
        };
        C.addTest("objectfit", !!M("objectFit"), {
            aliases: ["object-fit"]
        }), o(), r(y), delete w.addTest, delete w.addAsyncTest;
        for (var j = 0; j < C._q.length; j++) C._q[j]();
        t.Modernizr = C
    }(window, document), "undefined" == typeof jQuery) throw new Error("Bootstrap's JavaScript requires jQuery"); + function(t) {
    "use strict";
    ...
    e = n.special.debouncedresize = {
        ...
        handler: function(t, o) {
            var r = this,
                s = arguments,
                a = function() {
                    t.type = "debouncedresize", n.dispatch.apply(r, s)
                };
            i && clearTimeout(i), o ? a() : i = setTimeout(a, e.threshold)
        },
        threshold: 150
    }
}(jQuery),
function() {
    ...
    if (void 0 == jQuery) return void console.log("Jquery not included!");
    var e = jQuery,
        i = t(),
        n = 0,
        o = 0,
    ...
    jQuery.fn.extend({
        ensureLoad: function(t) {
            return this.each(function() {
                this.complete || 4 === this.readyState ? t.call(this) : "uninitialized" === this.readyState && 0 === this.src.indexOf("data:") ? (e(this).trigger("error"), t.call(this)) : (e(this).one("load", t), i && void 0 != this.src && this.src.indexOf("?") == -1 && (this.src = this.src + "?" + (new Date).getTime()))
            })
        }
    }), video_background = function(t, i) {
        return this.hidden = !1, this.$holder = t, this.isVimeoPlaying = !0, this.isVimeoMute = 1, this.id = "video_background_video_" + n, n++, this.parameters = {
            position: "absolute",
            "z-index": "-1",
            video_ratio: !1,
            loop: !0,
            ...
            mobile_play: "no",
            tranitionIn: !0
        }, e.each(i, e.proxy(function(t, e) {
            this.parameters[t] = e
        }, this)), this.$video_holder = e('<div id="' + this.id + '" class="kl-video-holder"></div>').appendTo(t).css({
            ...
            bottom: 0,
            overflow: "hidden"
        }), this.parameters.tranitionIn && this.$video_holder.addClass("video-transition-in"), 0 != this.parameters.video_overlay && this.$video_holder.addClass("video-grid-overlay video-grid-overlay-" + this.parameters.video_overlay), this.ismobile = navigator.userAgent.match(/(iPad)|(iPhone)|(iPod)|(android)|(webOS)/i), this.decision = "image", this.ismobile || (this.decision = this.parameters.priority, this.parameters.youtube !== !1 ? this.decision = "youtube" : this.parameters.vimeo !== !1 ? this.decision = "vimeo" : this.decision = "html5"), "image" == this.decision ? this.make_image() : "youtube" == this.decision ? this.make_youtube() : "vimeo" == this.decision ? this.make_vimeo() : this.make_video(), this
    }, video_background.prototype = {
        make_video: function() {
            var t = (this.parameters.autoplay ? "autoplay " : "") + (this.parameters.loop ? 'loop onended="this.play()" ' : ""),
                i = '<video width="100%" height="100%" ' + t + ">";
            this.parameters.mp4 !== !1 && (i += '<source src="' + this.parameters.mp4 + '" type="video/mp4"></source>'), this.parameters.webm !== !1 && (i += '<source src="' + this.parameters.webm + '" type="video/webm"></source>'), this.parameters.ogg !== !1 && (i += '<source src="' + this.parameters.ogg + '" type="video/ogg"></source>'), i += "</video>", this.$video = e(i).addClass("cover-fit-img").css({
                position: "absolute"
            }), this.$video_holder.append(this.$video), this.video = this.$video.get(0), "object" != typeof Modernizr || Modernizr.objectfit ? this.$video.css({
                width: "100%",
                height: "100%"
            }) : this.parameters.video_ratio !== !1 && (this.resize_timeout = !1, e(window).resize(e.proxy(function() {
                clearTimeout(this.resize_timeout), this.resize_timeout = setTimeout(e.proxy(this.video_resize, this), 10)
            }, this)), this.video_resize()), this.$video_holder.addClass("video-is-loaded"), this.parameters.muted && this.mute(), this.parameters.controls && this.make_controls()
        },
        video_resize: function(t) {
            this.$video = "undefined" != typeof t && t === !0 ? this.$video.children("iframe") : this.$video;
            var e = this.$video_holder.width(),
                i = this.$video_holder.height(),
                n = e,
                o = e / this.parameters.video_ratio;
            o < i && (o = i, n = i * this.parameters.video_ratio), o = Math.ceil(o), n = Math.ceil(n);
            var r = Math.round(i / 2 - o / 2),
                s = Math.round(e / 2 - n / 2);
            this.$video.attr("width", n), this.$video.attr("height", o), this.$video.css({
                position: "absolute",
                top: r + "px",
                left: s + "px"
            })
        ...
        make_youtube: function() {
            ...
            if (this.$video = e('<div id="' + this.id + '_yt"></div>').appendTo(this.$video_holder).css({
                ...
                n.parentNode.insertBefore(i, n), o = 1, window.onYouTubeIframeAPIReady = e.proxy(function() {
                    t.trigger("yt_loaded"), this.build_youtube(), o = 2
                }, this)
            } else 1 == o ? t.bind("yt_loaded", e.proxy(this.build_youtube, this)) : 2 == o && this.build_youtube()
        },
        build_youtube: function() {
            ...
            this.parameters.loop && (t.playlist = this.parameters.youtube), this.player = new YT.Player(this.id + "_yt", {
                height: "100%",
                width: "100%",
                playerVars: t,
        ...
        youtube_ready_fun: function(t) {
            this.youtube_ready = !0, this.$video = e("#" + this.id + "_yt"), this.$video_holder.addClass("video-is-loaded"), this.parameters.video_ratio !== !1 && (this.resize_timeout = !1, e(window).resize(e.proxy(function() {
                clearTimeout(this.resize_timeout), this.resize_timeout = setTimeout(e.proxy(this.video_resize, this), 10)
            }, this)), this.video_resize()), this.parameters.muted && this.mute(), this.parameters.controls && this.make_controls()
        },
        make_vimeo: function() {
            e("html");
            this.$video = e('<div id="' + this.id + '_vm"></div>').appendTo(this.$video_holder).css({
                position: "absolute",
                top: 0,
                left: 0,
                right: 0,
                bottom: 0
            }), this.vimeo_ready = !1, 0 === r ? e.getScript("//player.vimeo.com/api/player.js", e.proxy(function() {
                this.build_vimeo(), r = 1
            }, this)) : 1 == r && this.build_vimeo()
        },
        ...
        vimeo_ready_fun: function(t) {
            this.vimeo_ready = !0, this.$video = e("#" + this.id + "_vm"), this.$video_holder.addClass("video-is-loaded"), this.parameters.video_ratio !== !1 && (this.resize_timeout = !1,
                e(window).resize(e.proxy(function() {
                    clearTimeout(this.resize_timeout), this.resize_timeout = setTimeout(e.proxy(this.video_resize, this), 10)
                }, this)), this.video_resize(!0)), this.parameters.start && this.player.setCurrentTime(this.parameters.start), this.parameters.muted && (this.isVimeoMute = !0, this.mute()), this.parameters.controls && this.make_controls()
        },
        make_controls: function() {
            var t, i = this;
            t = '<ul class="kl-video--controls" data-position="' + this.parameters.controls_position + '">', t += '<li><a href="#" class="btn-toggleplay kl-video--controls-toggleplay">', t += '<i class="kl-icon glyphicon glyphicon-play circled-icon ' + (this.isPlaying() ? "" : "paused") + '"></i>', t += "</a></li>", t += '<li><a href="#" class="btn-audio kl-video--controls-togglemute">', t += '<i class="kl-icon glyphicon glyphicon-volume-up circled-icon ci-xsmall ' + (this.parameters.muted ? "mute" : "") + '"></i>', t += "</a></li>", t += "</ul>", e(t).appendTo(this.$video_holder), this.$video_holder.find(".btn-toggleplay").on("click", function(t) {
                t.preventDefault(), i.toggle_play(), e(this).children("i").toggleClass("paused")
            }), this.$video_holder.find(".btn-audio").on("click", function(t) {
                t.preventDefault(), i.toggle_mute(), e(this).children("i").toggleClass("mute")
            })
        },
        make_image: function() {
            this.parameters.fallback_image !== !1 && "" != this.parameters.fallback_image && (this.$img = e('<img src="' + this.parameters.fallback_image + '" class="cover-fit-img" alt=""/>').appendTo(this.$video_holder).css({
                position: "absolute"
            }), "object" != typeof Modernizr || Modernizr.objectfit ? this.$img.css({
                width: "100%",
                height: "100%"
        ...
        image_resize: function() {
            var t = this.$video_holder.width(),
                ...
                i = t,
                n = this.original_height / (this.original_width / t);
            ("adjust" == this.parameters.sizing && n > e || "fill" == this.parameters.sizing && n < e) && (n = e, i = this.original_width / (this.original_height / e)), n = Math.ceil(n), i = Math.ceil(i);
            var o = Math.round(e / 2 - n / 2),
                r = Math.round(t / 2 - i / 2);
            this.$img.css({
                width: i + "px",
                height: n + "px",
                top: o + "px",
        ...
        isPlaying: function() {
            ...
            if ("youtube" == this.decision && this.youtube_ready) return 1 === this.player.getPlayerState();
            if ("vimeo" == this.decision && this.vimeo_ready) {
                var t = this;
                return this.player.getPaused().then(function(e) {
                    t.funcIsVimeoPlaying(!e)
                }), this.isVimeoPlaying
            }
            return !1
        },
        play: function() {
            "html5" == this.decision ? this.video.play() : "youtube" == this.decision && this.youtube_ready ? this.player.playVideo() : "vimeo" == this.decision && this.vimeo_ready && this.player.play()
        },
        pause: function() {
            "html5" == this.decision ? this.video.pause() : "youtube" == this.decision && this.youtube_ready ? this.player.pauseVideo() : "vimeo" == this.decision && this.vimeo_ready && this.player.pause()
        },
        ...
        isMuted: function() {
            ...
            if ("youtube" == this.decision && this.youtube_ready) return this.player.isMuted();
            if ("vimeo" == this.decision && this.vimeo_ready) {
                var t = this;
                return this.player.getVolume().then(function(e) {
                    t.funcIsVimeoMute(0 === e)
                }), this.isVimeoMute
            }
            return !1
        },
        mute: function() {
            "html5" == this.decision ? this.video.volume = 0 : "youtube" == this.decision && this.youtube_ready ? this.player.mute() : "vimeo" == this.decision && this.vimeo_ready && this.player.setVolume(0)
        },
        unmute: function() {
            "html5" == this.decision ? this.video.volume = 1 : "youtube" == this.decision && this.youtube_ready ? this.player.unMute() : "vimeo" == this.decision && this.vimeo_ready && this.player.setVolume(1)
        },
        ...
        rewind: function() {
            "html5" == this.decision ? this.video.currentTime = 0 : "youtube" == this.decision && this.youtube_ready ? this.player.seekTo(0) : "vimeo" == this.decision && this.vimeo_ready && this.player.setCurrentTime(0)
        }
    }
}(void 0), ! function(t) {
    "use strict";
...
function() {
    ...
    function(t, e) {
        function i(e) {
            var i, n = t("<div></div>").css({
                width: "100%"
            });
            return e.append(n), i = e.width() - n.width(), n.remove(), i
        }
        ...
        function n(o, r) {
            var s = o.getBoundingClientRect(),
                ...
                p = !1,
                h = u.viewport.jquery ? u.viewport : t(u.viewport);
            ...
            if (h[0] !== e && "[object Window]" !== v && "[object DOMWindow]" !== v) {
                var g = h[0].getBoundingClientRect();
                a -= g.top, l -= g.top, c -= g.left, d -= g.left, n.scrollBarWidth = n.scrollBarWidth || i(h), m -= n.scrollBarWidth
            }
            return u.tolerance = ~~Math.round(parseFloat(u.tolerance)), u.tolerance < 0 && (u.tolerance = f + u.tolerance), d <= 0 || c >= m ? p : p = u.tolerance ? a <= u.tolerance && l >= u.tolerance : l > 0 && a <= f
        }
        ...
        var o = function(e) {
            ...
            for (var i = 0; i < e.length; i++)
                if ("function" == typeof e[i])
                    for (var n = 0; n < this.length; n++) e[i].call(t(this[n]));
        ...
        t.fn["do"] = function(t) {
            return console.warn("isInViewport: .do is deprecated as it causes issues in IE and some browsers since it's a reserved word. Use $.fn.run instead i.e., $(el).run(fn)."), o(t)
        }, t.fn.run = o;
        var r = function(e) {
            if (e) {
                var i = e.split(",");
    ...
    function(t, e) {
        ...
        b.prototype = {
            ...
            open: function(i) {
                ...
                I("BeforeOpen"), e.st.showCloseBtn && (e.st.closeBtnInside ? (_(u, function(t, e, i, n) {
                ...
                return e.isIE7 && (g += " mfp-ie7"), g && e._addClassToMFP(g), e.updateItemHTML(), I("BuildControls"), t("html").css(h), e.bgOverlay.add(e.wrap).prependTo(e.st.prependTo || t(document.body)), e._lastFocusedEl = document.activeElement, setTimeout(function() {
            ...
            updateItemHTML: function() {
                ...
                if (I("BeforeChange", [e.currItem ? e.currItem.type : "", n]), e.currItem = i, !e.currTemplate[n]) {
                    ...
                    I("FirstMarkupParse", r), r ? e.currTemplate[n] = t(r) : e.currTemplate[n] = !0
                }
                o && o !== i.type && e.container.removeClass("mfp-" + o + "-holder");
                var s = e["get" + n.charAt(0).toUpperCase() + n.slice(1)](i, e.currTemplate[n]);
                e.appendContent(s, n), i.preloaded = !0, I(h, i), o = i.type, e.container.prepend(e.contentContainer), I("AfterChange")
            },
            appendContent: function(t, i) {
                e.content = t, t ? e.st.showCloseBtn && e.st.closeBtnInside && e.currTemplate[i] === !0 ? e.content.find(".mfp-close").length || e.content.append(x()) : e.content = t : e.content = "", I(d), e.container.addClass("mfp-" + i + "-holder"), e.contentContainer.append(e.content)
            },
            parseEl: function(i) {
                var n, o = e.items[i];
                if (o.tagName ? o = {
            ...
            _parseMarkup: function(e, i, n) {
                var o;
                n.data && (i = t.extend(n.data, i)), I(u, [e, i, n]), t.each(i, function(t, i) {
        ...
        var S, O, P, $ = "inline",
            M = function() {
                P && (O.after(P.addClass(S)).detach(), P = null)
            };
                ...
                getInline: function(i, n) {
                    if (M(), i.src) {
                        ...
                        if (r.length) {
                            ...
                            s && s.tagName && (O || (S = o.hiddenClass, O = T(S), S = "mfp-" + S), P = r.after(O).detach().removeClass(S)), e.updateStatus("ready")
        ...
        t.magnificPopup.registerModule(z, {
            ...
            proto: {
                initAjax: function() {
                    e.types.push(z), j = e.st.ajax.cursor, _(a + "." + z, L), _("BeforeChange." + z, L)
                },
                getAjax: function(i) {
                    ...
                    var n = t.extend({
                        ...
                        success: function(n, o, r) {
                            ...
                            I("ParseAjax", s), e.appendContent(t(s.data), z), i.finished = !0, A(), e._setFocus(), setTimeout(function() {
                                e.wrap.addClass(v)
        ...
        t.magnificPopup.registerModule("image", {
            ...
            proto: {
                ...
                getImage: function(i, n) {
                    var o = 0,
                        r = function() {
                            i && (i.img[0].complete ? (i.img.off(".mfploader"), i === e.currItem && (e._onImageHasSize(i), e.updateStatus("ready")), i.hasSize = !0, i.loaded = !0, I("ImageLoadComplete")) : (o++, 200 > o ? setTimeout(r, 100) : s()));
                        },
                        s = function() {
        ...
        var V = "iframe",
            ...
            Q = function(t) {
                if (e.currTemplate[V]) {
                    var i = e.currTemplate[V].find("iframe");
        ...
        t.magnificPopup.registerModule(V, {
            ...
            proto: {
                initIframe: function() {
                    e.types.push(V), _("BeforeChange", function(t, e, i) {
                        e !== i && (e === V ? Q() : i === V && Q(!0))
                    }), _(a + "." + V, function() {
                        Q()
                    })
        ...
        t.magnificPopup.registerModule("gallery", {
            ...
            proto: {
                initGallery: function() {
                    ...
                    }), _(u + o, function(t, n, o, r) {
                        var s = e.items.length;
                        o.counter = s > 1 ? H(i.tCounter, r.index, s) : ""
        ...
        t.magnificPopup.registerModule(U, {
            ...
            function() {
                ...
                t.fn.mfpFastClick = function(o) {
                    return t(this).each(function() {
                        ...
                        if (i) {
                            ...
                            a.on("touchstart" + r, function(t) {
                                u = !1, h = 1, p = t.originalEvent ? t.originalEvent.touches[0] : t.touches[0], c = p.clientX, d = p.clientY, C.on("touchmove" + r, function(t) {
                                    p = t.originalEvent ? t.originalEvent.touches : t.touches, h = p.length, p = p[0], (Math.abs(p.clientX - c) > 10 || Math.abs(p.clientY - d) > 10) && (u = !0, n())
                                }).on("touchend" + r, function(t) {
                                    n(), u || h > 1 || (s = !0, t.preventDefault(), clearTimeout(l), l = setTimeout(function() {
                                        s = !1
                                    }, e), o())
                                })
                            })
                    ...
                    t(this).off("touchstart" + r + " click" + r), i && C.off("touchmove" + r + " touchend" + r)
                }
            }(), E()
    });